...
#     # Header Section
#     # st.markdown('<h1 class="main-header" style: "font-size : 100px;">FinTrack: Smart Expense Management</h1>',
#     #             unsafe_allow_html=True)
#     st.markdown('<h1 class="main-header" style="font-size: 80px;">FinTrack: Smart Expense Management</h1>',
#                 unsafe_allow_html=True)
...
#     # Call to Action
#     # st.markdown("""
#     # <a href="/ScanRecipt" class="cta-button">Start Your Financial Journey</a>
#     # """, unsafe_allow_html=True)
